                                ...
                                <tbody>
                                    @foreach ($libros as $libro)
                                        <tr>
                                            ...
                                            <!-- Se usa la variable de la tabla débil para acceder a los valores
                                            de la tabla fuerte, gracias a que el modela de esta se incluye en el controlador
                                            y modelo de la tabla débil; la instrucción se leería:

                                            $tablaDebil->tablaFuerte->campoTablaFuerte
                                            -->
